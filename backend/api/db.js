  ...
  try {
    ...
    const homestay = await prisma.homestay.update({
      ...
      data: {
        title,
        location,
        price: price !== undefined && price !== '' ? parseInt(price) : undefined,
        images,
        type,
        // BUG-016修复: 使用 !== undefined && !== '' 而不是 truthy 检查，允许0值保存
        guests: guests !== undefined && guests !== '' ? parseInt(guests) : undefined,
        bedrooms: bedrooms !== undefined && bedrooms !== '' ? parseInt(bedrooms) : undefined,
        beds: beds !== undefined && beds !== '' ? parseInt(beds) : undefined,
        bathrooms: bathrooms !== undefined && bathrooms !== '' ? parseInt(bathrooms) : undefined,
        amenities,
        description,
      },
    });
