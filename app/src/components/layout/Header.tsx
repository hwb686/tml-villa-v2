...
const breadcrumbMap: Record<string, string> = {
  ...
  homestays: '民宿管理',
  stock: '库存管理',
  'orders/homestay': '订单管理 / 民宿订单',
  'car-rentals': '订单管理 / 租车订单',
  'ticket-orders': '订单管理 / 票务订单',
  'meal-orders': '订单管理 / 订餐订单',
  'meal-configs': '业务配置 / 餐饮配置',
  'car-configs': '业务配置 / 车辆配置',
  'ticket-configs': '业务配置 / 票务配置',
  'finance/overview': '财务管理 / 收入统计',
  'finance/withdrawal': '财务管理 / 提现管理',
  'finance/transactions': '财务管理 / 交易记录',
  settings: '系统设置',
};
        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center gap-2">
                <Avatar className="h-8 w-8">
                  <AvatarFallback className="bg-champagne text-white text-sm">A</AvatarFallback>
                </Avatar>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => window.location.hash = '#/admin/settings'}>
                修改密码
              </DropdownMenuItem>
              <DropdownMenuSeparator />
