...
const translations = {
  th: {
    ...
    homestayDetail: {
      ...
      shareFailed: 'แชร์ล้มเหลว กรุณาลองใหม่',
      pleaseLogin: 'กรุณาเข้าสู่ระบบก่อน',
      loginToFavorite: 'เข้าสู่ระบบเพื่อบันทึกรายการ',
      favorited: 'บันทึกแล้ว',
      unfavorited: 'ยกเลิกบันทึกแล้ว',
      ...
      notesPlaceholder: 'หากมีความต้องการพิเศษกรุณาระบุที่นี่',
      fillContact: 'กรุณากรอกข้อมูลติดต่อเพื่อให้เรายืนยันคำสั่งซื้อ',
      fillNameAndPhone: 'กรุณากรอกชื่อและเบอร์โทรศัพท์',
  ...
  en: {
    ...
    homestayDetail: {
      ...
      loginToFavorite: 'Login to save this listing',
      favorited: 'Saved',
      ...
      notesPlaceholder: 'If you have special requests, please specify here',
      fillContact: 'Please fill in your contact info so we can confirm your order',
      fillNameAndPhone: 'Please enter your name and phone number',
  ...
  zh: {
    ...
    homestayDetail: {
      ...
      enterPhone: '请输入联系电话',
      enterEmail: '请输入邮箱地址',
      notesPlaceholder: '如有特殊要求请在此说明',
      fillContact: '请填写您的联系方式以便我们与您确认订单',
      fillNameAndPhone: '请填写姓名和联系电话',
